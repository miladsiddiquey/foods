                ...
                <h2 class="accordion-header" id="flush-headingOne">
                  ...
                  >
                    <div class="faq-title">
                      ...
                      <h4>Traditional Style Buffalo Wings</h4>
                    </div>
                  </button>
                </h2>
                <div
                    ...
                    <ul class="food-details">
                      <li>
                        ...
                        <div class="food-details-right">
                          ...
                          <button
                            class="view-product simple-modal-btn"
                            date-info="food-modal-main-2"
                          >
                            View Product
                          </button>
                        </div>

                        <div class="simple-modal" id="food-modal-main-2">
                          <div class="simple-modal-box">
                            <div class="simple-modal-header">
                              <h5>Food Details</h5>
                              <i class="fa-solid fa-xmark"></i>
                    ...
                    <ul class="food-details">
                      <li>
                        ...
                        <div class="food-details-right">
                          ...
                          <button
                            class="view-product simple-modal-btn"
                            date-info="food-modal-main-3"
                          >
                            View Product
                          </button>
                        </div>

                        <div class="simple-modal" id="food-modal-main-3">
                          <div class="simple-modal-box">
                            <div class="simple-modal-header">
                              <h5>Food Details</h5>
                              <i class="fa-solid fa-xmark"></i>
